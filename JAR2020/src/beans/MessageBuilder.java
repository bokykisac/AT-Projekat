...
public class MessageBuilder {
	...
	public static boolean sendACL(ACLMessage msg) {
		try {
			...
			ConnectionFactory cf = (ConnectionFactory) context.lookup(MessageBuilder.FACTORY);
			System.out.println(cf);
			final Queue queue = (Queue) context.lookup(MessageBuilder.MDB_CONSUMER_QUEUE);
			context.close();
			Connection connection = cf.createConnection(MessageBuilder.USERNAME, MessageBuilder.PASSWORD);
